...
import Diploma from '../assets/about/diploma2.jpeg';
import VideoGames from '../assets/about/videogames.jpeg';
                ...
                <div className="about-list-container">
                    <ul className="hobbies-list">
                        <li className="hobbies-list-item">
                            <img src={Paris} className="hobbies-list-item-picture" alt={translations.parisAlt || "Photo de Paris, la Tour Eiffel au loin."} />
                        ...
                        <li className="hobbies-list-item">
                            <img src={Coding} className="hobbies-list-item-picture" alt={translations.codingAlt || "Photo d'un ordinateur avec du code sur l'écran, et un carnet ouvert."} />
                        ...
                        <li className="hobbies-list-item">
                            <img src={Diploma} className="hobbies-list-item-picture" alt={translations.diplomaAlt || "Photo de chapeaux de diplômés lancés dans les airs."} />
                        ...
                        <li className="hobbies-list-item">
                            <img src={VideoGames} className="hobbies-list-item-picture" alt={translations.videoGamesAlt || "Photo d'une console switch, avec le jeu Zelda."} />
